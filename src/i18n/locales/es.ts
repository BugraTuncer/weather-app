export const es = {
  weather: {
    ...
    clickToGetWeather:
      "Haz clic en el botón de abajo para obtener el clima de tu ubicación actual.",
    weatherDataUnavailable: "Datos del Clima No Disponibles",
    unableToGetLocation:
  ...
  forecast: {
    ...
    noForecastData: "No hay datos de pronóstico disponibles",
    forecastWillAppear:
